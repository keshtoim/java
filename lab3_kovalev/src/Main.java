// Округление:
// Math.round - по математике; Math.rint - по банковскому принципу;
// (int) x - отбрасывание дробной части; printf(".%xf", y) где x - количество знаков после запятой, y - само число
